...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/jacquessinger/Documents/Academics/Research/BCI Projects/MIL_PsychoPy_fMRI/training/training_task_lastrun.py',
...
def setupDevices(expInfo, thisExp, win):
    ...
    if deviceManager.getDevice('key_resp_verif_1') is None:
        # initialise key_resp_verif_1
        key_resp_verif_1 = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='key_resp_verif_1',
        )
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Welcome! Let’s start with a brief training before we move to the scanner.\n\nPress any key to start.',
        font='Arial',
    ...
    # --- Initialize components for Routine "coherence_ins" ---
    ...
    # --- Initialize components for Routine "coherence_reading" ---
    ...
    # --- Initialize components for Routine "coherence_task" ---
    ...
    task_verification_message = visual.TextStim(win=win, name='task_verification_message',
        text='Were you able to complete the task successfully? \n\nPress 1 for yes and 2 for no. ',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=0.0);
    key_resp_verif_1 = keyboard.Keyboard(deviceName='key_resp_verif_1')
    
    # --- Initialize components for Routine "coherence_control" ---
    ...
    # --- Initialize components for Routine "instructions_significance" ---
    ...
    # --- Initialize components for Routine "significance_reading" ---
    ...
    # --- Initialize components for Routine "significance_control" ---
    ...
    # --- Initialize components for Routine "significance_task" ---
    ...
    # --- Initialize components for Routine "purpose_task" ---
    ...
    # --- Initialize components for Routine "purpose_control" ---
    ...
    for thisTrial_2 in trials_2:
        ...
        for thisTrial in trials:
            ...
            # --- Prepare to start Routine "coherence_ins" ---
            # create an object to store info about Routine coherence_ins
            coherence_ins = data.Routine(
                name='coherence_ins',
                components=[key_resp, textbox_2],
            )
            coherence_ins.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            ...
            _key_resp_allKeys = []
            textbox_2.reset()
            # store start times for coherence_ins
            coherence_ins.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            coherence_ins.tStart = globalClock.getTime(format='float')
            coherence_ins.status = STARTED
            thisExp.addData('coherence_ins.started', coherence_ins.tStart)
            coherence_ins.maxDuration = None
            # keep track of which components have finished
            coherence_insComponents = coherence_ins.components
            for thisComponent in coherence_ins.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "coherence_ins" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            coherence_ins.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine:
                # get current time
                t = routineTimer.getTime()
                tThisFlip = win.getFutureFlipTime(clock=routineTimer)
                ...
                if textbox_2.status == STARTED:
                    # update params
                    textbox_2.setText(coherence_instructions, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    coherence_ins.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in coherence_ins.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "coherence_ins" ---
            for thisComponent in coherence_ins.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for coherence_ins
            coherence_ins.tStop = globalClock.getTime(format='float')
            coherence_ins.tStopRefresh = tThisFlipGlobal
            thisExp.addData('coherence_ins.stopped', coherence_ins.tStop)
            # check responses
            ...
            # the Routine "coherence_ins" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            ...
            # --- Prepare to start Routine "coherence_reading" ---
            # create an object to store info about Routine coherence_reading
            coherence_reading = data.Routine(
                name='coherence_reading',
                components=[textbox_coherence],
            )
            coherence_reading.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            textbox_coherence.reset()
            # store start times for coherence_reading
            coherence_reading.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            coherence_reading.tStart = globalClock.getTime(format='float')
            coherence_reading.status = STARTED
            thisExp.addData('coherence_reading.started', coherence_reading.tStart)
            coherence_reading.maxDuration = None
            # keep track of which components have finished
            coherence_readingComponents = coherence_reading.components
            for thisComponent in coherence_reading.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            while continueRoutine and routineTimer.getTime() < 10.0:
                ...
                if textbox_coherence.status == STARTED:
                    # update params
                    textbox_coherence.setText(training_text_coherence
                    , log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    coherence_reading.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in coherence_reading.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "coherence_reading" ---
            for thisComponent in coherence_reading.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for coherence_reading
            coherence_reading.tStop = globalClock.getTime(format='float')
            coherence_reading.tStopRefresh = tThisFlipGlobal
            thisExp.addData('coherence_reading.stopped', coherence_reading.tStop)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if coherence_reading.maxDurationReached:
                routineTimer.addTime(-coherence_reading.maxDuration)
            ...
            coherence_task = data.Routine(
                name='coherence_task',
                components=[textbox_task],
            )
            coherence_task.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            textbox_task.reset()
            # store start times for coherence_task
            coherence_task.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            coherence_task.tStart = globalClock.getTime(format='float')
            coherence_task.status = STARTED
            thisExp.addData('coherence_task.started', coherence_task.tStart)
            coherence_task.maxDuration = None
            # keep track of which components have finished
            coherence_taskComponents = coherence_task.components
            for thisComponent in coherence_task.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "coherence_task" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            coherence_task.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine and routineTimer.getTime() < 20.0:
                ...
                if textbox_task.status == STARTED:
                    # update params
                    textbox_task.setText(training_text_coherence, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    coherence_task.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in coherence_task.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "coherence_task" ---
            for thisComponent in coherence_task.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for coherence_task
            coherence_task.tStop = globalClock.getTime(format='float')
            coherence_task.tStopRefresh = tThisFlipGlobal
            thisExp.addData('coherence_task.stopped', coherence_task.tStop)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if coherence_task.maxDurationReached:
                routineTimer.addTime(-coherence_task.maxDuration)
            elif coherence_task.forceEnded:
                routineTimer.reset()
            else:
            ...
            task_verification = data.Routine(
                ...
                components=[task_verification_message, key_resp_verif_1],
            )
            ...
            while continueRoutine and routineTimer.getTime() < 7.0:
                ...
                # if key_resp_verif_1 is starting this frame...
                if key_resp_verif_1.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    key_resp_verif_1.frameNStart = frameN  # exact frame index
                    key_resp_verif_1.tStart = t  # local t and not account for scr refresh
                    key_resp_verif_1.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(key_resp_verif_1, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'key_resp_verif_1.started')
                    # update status
                    key_resp_verif_1.status = STARTED
                    # keyboard checking is just starting
                    waitOnFlip = True
                    win.callOnFlip(key_resp_verif_1.clock.reset)  # t=0 on next screen flip
                    win.callOnFlip(key_resp_verif_1.clearEvents, eventType='keyboard')  # clear events on next screen flip
                ...
                if key_resp_verif_1.status == STARTED:
                    ...
                    if tThisFlipGlobal > key_resp_verif_1.tStartRefresh + 7-frameTolerance:
                        ...
                        key_resp_verif_1.frameNStop = frameN  # exact frame index
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'key_resp_verif_1.stopped')
                        # update status
                        key_resp_verif_1.status = FINISHED
                        key_resp_verif_1.status = FINISHED
                if key_resp_verif_1.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_verif_1.getKeys(keyList=["1","2"], ignoreKeys=["escape"], waitRelease=False)
                    _key_resp_verif_1_allKeys.extend(theseKeys)
                    if len(_key_resp_verif_1_allKeys):
                        key_resp_verif_1.keys = _key_resp_verif_1_allKeys[-1].name  # just the last key pressed
                        key_resp_verif_1.rt = _key_resp_verif_1_allKeys[-1].rt
                        key_resp_verif_1.duration = _key_resp_verif_1_allKeys[-1].duration
            ...
            # check responses
            if key_resp_verif_1.keys in ['', [], None]:  # No response was made
                key_resp_verif_1.keys = None
            trials.addData('key_resp_verif_1.keys',key_resp_verif_1.keys)
            if key_resp_verif_1.keys != None:  # we had a response
                trials.addData('key_resp_verif_1.rt', key_resp_verif_1.rt)
                trials.addData('key_resp_verif_1.duration', key_resp_verif_1.duration)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            ...
            coherence_control = data.Routine(
                name='coherence_control',
                components=[textbox],
            )
            coherence_control.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            textbox.reset()
            # store start times for coherence_control
            coherence_control.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            coherence_control.tStart = globalClock.getTime(format='float')
            coherence_control.status = STARTED
            thisExp.addData('coherence_control.started', coherence_control.tStart)
            coherence_control.maxDuration = None
            # keep track of which components have finished
            coherence_controlComponents = coherence_control.components
            for thisComponent in coherence_control.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "coherence_control" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            coherence_control.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine and routineTimer.getTime() < 20.0:
                # get current time
                t = routineTimer.getTime()
                tThisFlip = win.getFutureFlipTime(clock=routineTimer)
                ...
                if textbox.status == STARTED:
                    # update params
                    textbox.setText(training_text_coherence, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    coherence_control.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in coherence_control.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "coherence_control" ---
            for thisComponent in coherence_control.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for coherence_control
            coherence_control.tStop = globalClock.getTime(format='float')
            coherence_control.tStopRefresh = tThisFlipGlobal
            thisExp.addData('coherence_control.stopped', coherence_control.tStop)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if coherence_control.maxDurationReached:
                routineTimer.addTime(-coherence_control.maxDuration)
            elif coherence_control.forceEnded:
                routineTimer.reset()
            else:
                routineTimer.addTime(-20.000000)
            ...
            # --- Prepare to start Routine "instructions_significance" ---
            # create an object to store info about Routine instructions_significance
            instructions_significance = data.Routine(
                name='instructions_significance',
                components=[key_resp_3, textbox_3],
            )
            instructions_significance.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            ...
            _key_resp_3_allKeys = []
            textbox_3.reset()
            # store start times for instructions_significance
            instructions_significance.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            instructions_significance.tStart = globalClock.getTime(format='float')
            instructions_significance.status = STARTED
            thisExp.addData('instructions_significance.started', instructions_significance.tStart)
            instructions_significance.maxDuration = None
            # keep track of which components have finished
            instructions_significanceComponents = instructions_significance.components
            for thisComponent in instructions_significance.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "instructions_significance" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            instructions_significance.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine:
                # get current time
                t = routineTimer.getTime()
                tThisFlip = win.getFutureFlipTime(clock=routineTimer)
                ...
                if textbox_3.status == STARTED:
                    # update params
                    textbox_3.setText(significance_instructions, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    instructions_significance.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in instructions_significance.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "instructions_significance" ---
            for thisComponent in instructions_significance.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for instructions_significance
            instructions_significance.tStop = globalClock.getTime(format='float')
            instructions_significance.tStopRefresh = tThisFlipGlobal
            thisExp.addData('instructions_significance.stopped', instructions_significance.tStop)
            # check responses
            ...
            # the Routine "instructions_significance" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            
            # --- Prepare to start Routine "significance_reading" ---
            # create an object to store info about Routine significance_reading
            significance_reading = data.Routine(
                name='significance_reading',
                components=[reading2_textbox],
            )
            significance_reading.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            reading2_textbox.reset()
            # store start times for significance_reading
            significance_reading.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            significance_reading.tStart = globalClock.getTime(format='float')
            significance_reading.status = STARTED
            thisExp.addData('significance_reading.started', significance_reading.tStart)
            significance_reading.maxDuration = None
            # keep track of which components have finished
            significance_readingComponents = significance_reading.components
            for thisComponent in significance_reading.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "significance_reading" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            significance_reading.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine and routineTimer.getTime() < 10.0:
                # get current time
                t = routineTimer.getTime()
                tThisFlip = win.getFutureFlipTime(clock=routineTimer)
                ...
                if reading2_textbox.status == STARTED:
                    # update params
                    reading2_textbox.setText(training_text_significance, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    significance_reading.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in significance_reading.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "significance_reading" ---
            for thisComponent in significance_reading.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for significance_reading
            significance_reading.tStop = globalClock.getTime(format='float')
            significance_reading.tStopRefresh = tThisFlipGlobal
            thisExp.addData('significance_reading.stopped', significance_reading.tStop)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if significance_reading.maxDurationReached:
                routineTimer.addTime(-significance_reading.maxDuration)
            elif significance_reading.forceEnded:
                routineTimer.reset()
            else:
                routineTimer.addTime(-10.000000)
            
            # --- Prepare to start Routine "significance_control" ---
            # create an object to store info about Routine significance_control
            significance_control = data.Routine(
                name='significance_control',
                components=[control2_textbox],
            )
            significance_control.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            control2_textbox.reset()
            # store start times for significance_control
            significance_control.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            significance_control.tStart = globalClock.getTime(format='float')
            significance_control.status = STARTED
            thisExp.addData('significance_control.started', significance_control.tStart)
            significance_control.maxDuration = None
            # keep track of which components have finished
            significance_controlComponents = significance_control.components
            for thisComponent in significance_control.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "significance_control" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            significance_control.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine and routineTimer.getTime() < 20.0:
                # get current time
                t = routineTimer.getTime()
                tThisFlip = win.getFutureFlipTime(clock=routineTimer)
                ...
                if control2_textbox.status == STARTED:
                    # update params
                    control2_textbox.setText(training_text_significance, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    significance_control.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in significance_control.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "significance_control" ---
            for thisComponent in significance_control.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for significance_control
            significance_control.tStop = globalClock.getTime(format='float')
            significance_control.tStopRefresh = tThisFlipGlobal
            thisExp.addData('significance_control.stopped', significance_control.tStop)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if significance_control.maxDurationReached:
                routineTimer.addTime(-significance_control.maxDuration)
            elif significance_control.forceEnded:
                routineTimer.reset()
            else:
                routineTimer.addTime(-20.000000)
            ...
            significance_task = data.Routine(
                name='significance_task',
                components=[task2_textbox],
            )
            significance_task.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            task2_textbox.reset()
            # store start times for significance_task
            significance_task.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            significance_task.tStart = globalClock.getTime(format='float')
            significance_task.status = STARTED
            thisExp.addData('significance_task.started', significance_task.tStart)
            significance_task.maxDuration = None
            # keep track of which components have finished
            significance_taskComponents = significance_task.components
            for thisComponent in significance_task.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "significance_task" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            significance_task.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine and routineTimer.getTime() < 20.0:
                # get current time
                t = routineTimer.getTime()
                tThisFlip = win.getFutureFlipTime(clock=routineTimer)
                ...
                if task2_textbox.status == STARTED:
                    # update params
                    task2_textbox.setText(training_text_significance, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    significance_task.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in significance_task.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "significance_task" ---
            for thisComponent in significance_task.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for significance_task
            significance_task.tStop = globalClock.getTime(format='float')
            significance_task.tStopRefresh = tThisFlipGlobal
            thisExp.addData('significance_task.stopped', significance_task.tStop)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if significance_task.maxDurationReached:
                routineTimer.addTime(-significance_task.maxDuration)
            elif significance_task.forceEnded:
                routineTimer.reset()
            else:
                routineTimer.addTime(-20.000000)
            ...
            # --- Prepare to start Routine "instructions_purpose" ---
            ...
            _key_resp_4_allKeys = []
            textbox_4.reset()
            # store start times for instructions_purpose
            instructions_purpose.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            instructions_purpose.tStart = globalClock.getTime(format='float')
            instructions_purpose.status = STARTED
            thisExp.addData('instructions_purpose.started', instructions_purpose.tStart)
            instructions_purpose.maxDuration = None
            # keep track of which components have finished
            instructions_purposeComponents = instructions_purpose.components
            for thisComponent in instructions_purpose.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "instructions_purpose" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            instructions_purpose.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine:
                # get current time
                t = routineTimer.getTime()
                tThisFlip = win.getFutureFlipTime(clock=routineTimer)
                ...
                if textbox_4.status == STARTED:
                    # update params
                    textbox_4.setText(purpose_instructions, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    instructions_purpose.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in instructions_purpose.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "instructions_purpose" ---
            for thisComponent in instructions_purpose.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for instructions_purpose
            instructions_purpose.tStop = globalClock.getTime(format='float')
            instructions_purpose.tStopRefresh = tThisFlipGlobal
            thisExp.addData('instructions_purpose.stopped', instructions_purpose.tStop)
            # check responses
            ...
            # the Routine "instructions_purpose" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            
            # --- Prepare to start Routine "purpose_reading" ---
            # create an object to store info about Routine purpose_reading
            purpose_reading = data.Routine(
                name='purpose_reading',
                components=[reading3_textbox],
            )
            purpose_reading.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            reading3_textbox.reset()
            # store start times for purpose_reading
            purpose_reading.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            purpose_reading.tStart = globalClock.getTime(format='float')
            purpose_reading.status = STARTED
            thisExp.addData('purpose_reading.started', purpose_reading.tStart)
            purpose_reading.maxDuration = None
            # keep track of which components have finished
            purpose_readingComponents = purpose_reading.components
            for thisComponent in purpose_reading.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "purpose_reading" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            purpose_reading.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine and routineTimer.getTime() < 5.0:
                ...
                if reading3_textbox.status == STARTED:
                    # update params
                    reading3_textbox.setText(training_text_purpose, log=False)
                
                # if reading3_textbox is stopping this frame...
                if reading3_textbox.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > reading3_textbox.tStartRefresh + 5-frameTolerance:
                        # keep track of stop time/frame for later
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    purpose_reading.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in purpose_reading.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "purpose_reading" ---
            for thisComponent in purpose_reading.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for purpose_reading
            purpose_reading.tStop = globalClock.getTime(format='float')
            purpose_reading.tStopRefresh = tThisFlipGlobal
            thisExp.addData('purpose_reading.stopped', purpose_reading.tStop)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if purpose_reading.maxDurationReached:
                routineTimer.addTime(-purpose_reading.maxDuration)
            elif purpose_reading.forceEnded:
                routineTimer.reset()
            else:
                routineTimer.addTime(-5.000000)
            
            # --- Prepare to start Routine "purpose_task" ---
            # create an object to store info about Routine purpose_task
            purpose_task = data.Routine(
                name='purpose_task',
                components=[task3_textbox],
            )
            purpose_task.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            task3_textbox.reset()
            # store start times for purpose_task
            purpose_task.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            purpose_task.tStart = globalClock.getTime(format='float')
            purpose_task.status = STARTED
            thisExp.addData('purpose_task.started', purpose_task.tStart)
            purpose_task.maxDuration = None
            # keep track of which components have finished
            purpose_taskComponents = purpose_task.components
            for thisComponent in purpose_task.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "purpose_task" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            purpose_task.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine and routineTimer.getTime() < 20.0:
                # get current time
                t = routineTimer.getTime()
                tThisFlip = win.getFutureFlipTime(clock=routineTimer)
                ...
                if task3_textbox.status == STARTED:
                    # update params
                    task3_textbox.setText(training_text_purpose, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    purpose_task.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in purpose_task.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "purpose_task" ---
            for thisComponent in purpose_task.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for purpose_task
            purpose_task.tStop = globalClock.getTime(format='float')
            purpose_task.tStopRefresh = tThisFlipGlobal
            thisExp.addData('purpose_task.stopped', purpose_task.tStop)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if purpose_task.maxDurationReached:
                routineTimer.addTime(-purpose_task.maxDuration)
            elif purpose_task.forceEnded:
                routineTimer.reset()
            else:
                routineTimer.addTime(-20.000000)
            ...
            purpose_control = data.Routine(
                name='purpose_control',
                components=[control3_textbox],
            )
            purpose_control.status = NOT_STARTED
            continueRoutine = True
            # update component parameters for each repeat
            control3_textbox.reset()
            # store start times for purpose_control
            purpose_control.tStartRefresh = win.getFutureFlipTime(clock=globalClock)
            purpose_control.tStart = globalClock.getTime(format='float')
            purpose_control.status = STARTED
            thisExp.addData('purpose_control.started', purpose_control.tStart)
            purpose_control.maxDuration = None
            # keep track of which components have finished
            purpose_controlComponents = purpose_control.components
            for thisComponent in purpose_control.components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            # --- Run Routine "purpose_control" ---
            # if trial has changed, end Routine now
            if isinstance(trials, data.TrialHandler2) and thisTrial.thisN != trials.thisTrial.thisN:
                continueRoutine = False
            purpose_control.forceEnded = routineForceEnded = not continueRoutine
            while continueRoutine and routineTimer.getTime() < 20.0:
                # get current time
                t = routineTimer.getTime()
                tThisFlip = win.getFutureFlipTime(clock=routineTimer)
                ...
                if control3_textbox.status == STARTED:
                    # update params
                    control3_textbox.setText(training_text_purpose, log=False)
                ...
                # check if all components have finished
                if not continueRoutine:  # a component has requested a forced-end of Routine
                    purpose_control.forceEnded = routineForceEnded = True
                    break
                continueRoutine = False  # will revert to True if at least one component still running
                for thisComponent in purpose_control.components:
                    if hasattr(thisComponent, "status") and thisComponent.status != FINISHED:
            ...
            # --- Ending Routine "purpose_control" ---
            for thisComponent in purpose_control.components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            # store stop times for purpose_control
            purpose_control.tStop = globalClock.getTime(format='float')
            purpose_control.tStopRefresh = tThisFlipGlobal
            thisExp.addData('purpose_control.stopped', purpose_control.tStop)
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if purpose_control.maxDurationReached:
                routineTimer.addTime(-purpose_control.maxDuration)
            elif purpose_control.forceEnded:
                routineTimer.reset()
            else:
                routineTimer.addTime(-20.000000)
    ...
    while continueRoutine and routineTimer.getTime() < 12.0:
        ...
        if end_message.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > end_message.tStartRefresh + 12-frameTolerance:
                # keep track of stop time/frame for later
