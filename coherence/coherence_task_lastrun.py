...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/jacquessinger/Documents/Academics/Research/BCI Projects/MIL_PsychoPy_fMRI/coherence/coherence_task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    task_verification_message = visual.TextStim(win=win, name='task_verification_message',
        text='Did you think about how these events fit together and form a coherent life story? \n\nPress 1 for yes and 2 for no. ',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    for thisTrial_2 in trials_2:
        ...
        _key_resp_allKeys = []
        textbox_2.reset()
        textbox_2.setText(coherence_instructions)
    ...
    for thisTrial in trials:
        ...
        while continueRoutine and routineTimer.getTime() < 5.0:
            ...
            if textbox_coherence.status == STARTED:
                # update params
                textbox_coherence.setText(coherence_text_01
                , log=False)
        ...
        while continueRoutine and routineTimer.getTime() < 20.0:
            ...
            if textbox_task.status == STARTED:
                # update params
                textbox_task.setText(coherence_text_01, log=False)
        ...
        while continueRoutine and routineTimer.getTime() < 20.0:
            ...
            if textbox.status == STARTED:
                # update params
                textbox.setText(coherence_text_01
                , log=False)
        ...
        while continueRoutine and routineTimer.getTime() < 5.0:
            ...
            if reading2_textbox.status == STARTED:
                # update params
                reading2_textbox.setText(coherence_text_02, log=False)
            
            # if reading2_textbox is stopping this frame...
            if reading2_textbox.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > reading2_textbox.tStartRefresh + 5-frameTolerance:
                    # keep track of stop time/frame for later
        ...
        while continueRoutine and routineTimer.getTime() < 20.0:
            ...
            if control2_textbox.status == STARTED:
                # update params
                control2_textbox.setText(coherence_text_02, log=False)
        ...
        while continueRoutine and routineTimer.getTime() < 20.0:
            ...
            if task2_textbox.status == STARTED:
                # update params
                task2_textbox.setText(coherence_text_02, log=False)
        ...
        while continueRoutine and routineTimer.getTime() < 5.0:
            ...
            if reading3_textbox.status == STARTED:
                # update params
                reading3_textbox.setText(coherence_text_03, log=False)
        ...
        while continueRoutine and routineTimer.getTime() < 20.0:
            ...
            if task3_textbox.status == STARTED:
                # update params
                task3_textbox.setText(coherence_text_03, log=False)
        ...
        while continueRoutine and routineTimer.getTime() < 20.0:
            ...
            if control3_textbox.status == STARTED:
                # update params
                control3_textbox.setText(coherence_text_03, log=False)
